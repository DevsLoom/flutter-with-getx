...
class ForgetPassOtpScreen extends GetView<ForgetpassOtpController> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            24.verticalSpace,
            PinInputField(
              key: WidgetKeys.forgetpassOtpField,
              length: 6,
            ...
            128.verticalSpace,
            PrimaryButton(
              key: WidgetKeys.forgetpassOtpVerifyButton,
              text: 'Verify',
              onPressed: () => PageNavigationService.generalNavigation(
                Routes.forgetpassPasswordScreen,
              ),
            ),
          ],
        ),
