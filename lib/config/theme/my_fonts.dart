...
class MyFonts {
  ...
  // appbar font size
  static double get appBarTittleSize => 16.sp;

  // body font size
  static double get titleLargeTextSize => 32.sp;
  // body font size
  ...
  //button font size
  static double get primaryButtonTextSize => 18.sp;
  static double get buttonTextSize => 16.sp;
  //button font size
  static double get labelTextSize => 12.sp;

  //button font size
  static double get hintTextSize => 14.sp;

  //chip font size
  static double get chipTextSize => 14.sp;
