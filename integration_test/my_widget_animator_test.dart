...
import 'package:flutterwithgetx/app/components/my_widgets_animator.dart';
import 'package:flutterwithgetx/app/services/api_call_status.dart';
        ...
        body: Center(
          child: Obx(
            () => MyWidgetsAnimator(
              ...
              successWidget: () =>
                  const Text('Success', key: ValueKey('Success')),
              emptyWidget: () => const Text('Empty', key: ValueKey('Empty')),
              holdingWidget: () =>
                  const Text('Holding', key: ValueKey('Holding')),
            ),
          ),
        ),
      ),
